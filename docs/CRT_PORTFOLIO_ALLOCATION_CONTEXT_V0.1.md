...
## Strategic BTC Core / Acquisition Reserve??? BTC ?????????

Direct BTC holding??? BTC ???? `STRATEGIC_CORE`??????????????? Fixed Income / Growth???????????????????? `SEASON_POLICY`??? BTC quantity?BTC ??????? Capital State????????????? `UNPRICED_OR_UNCLASSIFIED_HOLDINGS`?

`strategic_btc_target`?BTC ??????? private context?????????????????Current BTC??? BTC??????? `holdings`?????? acquisition gap??????????????????

BTC Acquisition Reserve?BTC ????????????????? ledger?????Cross-season route?????????

`MSTR/ASST Peak Harvest -> BTC Acquisition Reserve -> eligible SATA/STRC or Cash -> Winter Staged BTC Acquisition`

?????? `action_output = NONE`?External Action Authority????????`NONE`?Capital Decision Authority????????`USER_ONLY`?
